  ...
  <form action="index.php?option=com_hdwmusic&task=albums" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
    <table style="padding-bottom:10px;">
      <tr>
        ...
        <td nowrap="nowrap"><?php echo $this->lists['genre']; ?> <?php echo $this->lists['artists']; ?> <?php echo $this->lists['state']; ?></td>
      </tr>
    </table>
    <table class="adminlist">
      <thead>
        <tr>
          ...
          <th><?php echo JText::_('ALBUM_NAME'); ?></th>
          <th width="25%"><?php echo JText::_('ARTIST_NAME'); ?></th>
      ...
      <tbody>
		...
		for ($i=0, $n=count($data); $i < $n; $i++) {
			...
			$link 		= JRoute::_( 'index.php?option=com_hdwmusic&task=editalbums&'. JSession::getFormToken() .'=1&'.'cid[]='. $row->id );
        ...
        <tr class="<?php echo "row$k"; ?>">
          ...
          <td align="center"><?php echo $row->album_artist;?> </td>
          <td align="center"><?php echo $row->album_genre;?> </td>
          <td align="center"><?php echo $row->album_views;?> </td>
          <td align="center"><?php echo $row->album_featured;?> </td>
