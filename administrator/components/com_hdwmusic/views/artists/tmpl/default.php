...
<div id="hdwmusic">
  <form action="index.php?option=com_hdwmusic&task=artists" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
    ...
    <table class="adminlist">
      <thead>
        <tr>
          ...
          <th><?php echo JText::_('ARTIST_IMAGE'); ?></th>
      ...
      <tbody>
		...
		for ($i=0, $n=count($data); $i < $n; $i++) {
			...
			$link 		= JRoute::_( 'index.php?option=com_hdwmusic&task=editartists&'. JSession::getFormToken() .'=1&'.'cid[]='. $row->id );
        ...
        <tr class="<?php echo "row$k"; ?>">
          ...
          <td align="center"><a href="<?php echo $link; ?>"> <?php echo $row->artist_name;?> </a> </td>
          <td align="center"><?php echo $row->artist_thumb;?> </td>
          <td align="center"><?php echo $row->artist_views;?> </td>
    ...
    <input type="hidden" name="task" value="artists" />
