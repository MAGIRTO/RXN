	...
	?>
        ...
        <div class="item">
      		...
      		if (!empty($row->profile_image)){ ?>
      			<a href="<?php echo JRoute::_('index.php?option=com_tlpteam&view=team&id='.(int) $row->id.'&Itemid='.$teammenuitem); ?>"><img src="<?php echo JURI::root().$image_storiage_path.'l_'.$row->profile_image;?>" /></a>
      			<?php
      		}else{ ?>
              	<img class="hwllow" src="<?php echo JURI::root().$image_storiage_path?>noimage.jpg" alt="noimage" />
              <?php }?>
        		<div class="tlp-team-name">
                <h3><a href="<?php echo JRoute::_('index.php?option=com_tlpteam&view=team&id='.(int)$row->id.'&Itemid='.$teammenuitem); ?>">
...
jQuery(document).ready(function() {
  jQuery("#tlp-team-module").owlCarousel({
