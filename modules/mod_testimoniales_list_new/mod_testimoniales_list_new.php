...
if( empty($style) )
{
    JFactory::getApplication()->enqueueMessage( 'Slider style no declared. Check testimoniales list new configuration and save again from admin panel' , 'error');
    return;
}
...
$helper = new mod_Testimonialeslistnew($params, $module_id);
