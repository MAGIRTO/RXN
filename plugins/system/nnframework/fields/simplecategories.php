...
class JFormFieldNN_SimpleCategories extends NNFormField
{
	...
	protected function getInput()
	{
		...
		NNFrameworkFunctions::script('nnframework/script.min.js', '16.2.24072');
		NNFrameworkFunctions::script('nnframework/toggler.min.js', '16.2.24072');
		...
		NNFrameworkFunctions::script('nnframework/simplecategories.min.js', '16.2.24072');
