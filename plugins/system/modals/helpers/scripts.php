...
class PlgSystemModalsHelperScripts
{
	...
	public function loadScriptsStyles()
	{
		...
		NNFrameworkFunctions::script('modals/script.min.js', ($this->params->media_versioning ? '6.3.1' : false));

		if ($this->params->load_stylesheet)
		{
			NNFrameworkFunctions::stylesheet('modals/' . $this->params->style . '.min.css', ($this->params->media_versioning ? '6.3.1' : false));
		}
	}
