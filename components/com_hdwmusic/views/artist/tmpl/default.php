...
<?php echo $artist->artist_header; ?> <br />
<div id="hdw_gallery<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>">
  ...
  <div class="hdw_thumb"> <a href="<?php echo JRoute::_($link.$albums[$i]->album_slug.$qs); ?>">
    ...
    <img src="<?php echo $albums[$i]->album_thumb; ?>" width="218" height="150" title="<?php echo 'Click to View : '.$albums[$i]->album_name; ?>" border="0" onmouseover="this.style.opacity=0.7" onmouseout="this.style.opacity=1"/> <span class="views"><strong>views : </strong><?php echo $albums[$i]->album_views; ?></span> <span class="genre"><strong>genre : </strong><?php echo $albums[$i]->album_genre; ?></span> </a> </div>
  <?php } ?>
</div>
<div style="clear:both"></div>
<div id="hdw_pagination<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>"><?php echo $this->pagination->getPagesLinks(); ?></div>
<br />
<?php echo $artist->artist_footer; ?>